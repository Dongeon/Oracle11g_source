...
{                                                                                                          
    class EX2_5dataService : DataService<EX2_5>                                             
    {                                                                                                      
        ...
        {                                                                                                  
            ...
            //string sql = GetSelectSQL(new EX2_5(), whereCondition);
        ...
        public List<EX2_5> _Read(OracleDataReader rdr)
        {                                                                                                  
            List<EX2_5> listEX2_5 = new List<EX2_5>();
            if (rdr.HasRows)                                                                               
            {                                                                                              
                while (rdr.Read())                                                                         
                {                                                                                          
                    ...
                    EX2_5 data = new EX2_5(splitresult);
