...
{                                                                                                          
    class EX2_10dataService : DataService<EX2_10>                                             
    {                                                                                                      
        ...
        {                                                                                                  
            ...
            //string sql = GetSelectSQL(new EX2_10(), whereCondition);
        ...
        public List<EX2_10> _Read(OracleDataReader rdr)
        {                                                                                                  
            List<EX2_10> listEX2_10 = new List<EX2_10>();
            if (rdr.HasRows)                                                                               
            {                                                                                              
                while (rdr.Read())                                                                         
                {                                                                                          
                    ...
                    EX2_10 data = new EX2_10(splitresult);
