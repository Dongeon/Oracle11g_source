...
, Nullable<DateTime> UPDATE_DATE
        ...
        {                                 
            ...
            {
                this.START_DATE = Convert.ToDateTime(splitresult[1])            }
            if (splitresult[2] == "")
            {
                this.END_DATE = null;            }
            else
            {
                this.END_DATE = Convert.ToDateTime(splitresult[2])            }
            ...
            {
                this.CREATE_DATE = Convert.ToDateTime(splitresult[5])            }
            if (splitresult[6] == "")
            {
                this.UPDATE_DATE = null;            }
            else
            {
                this.UPDATE_DATE = Convert.ToDateTime(splitresult[6])            }
        }                                 
        public void clear()               
        {                                 
