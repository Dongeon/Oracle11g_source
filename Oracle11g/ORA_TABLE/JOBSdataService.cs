...
{                                                                                                          
    class JOBSdataService : DataService<JOBS>                                             
    {                                                                                                      
        ...
        {                                                                                                  
            ...
            //string sql = GetSelectSQL(new JOBS(), whereCondition);
        ...
        public List<JOBS> _Read(OracleDataReader rdr)
        {                                                                                                  
            ...
            {                                                                                              
                ...
                {                                                                                          
                    ...
                    JOBS data = new JOBS(splitresult);
