...
{                                                                                                          
    class EX2_10_1dataService : DataService<EX2_10_1>                                             
    {                                                                                                      
        ...
        {                                                                                                  
            ...
            //string sql = GetSelectSQL(new EX2_10_1(), whereCondition);
        ...
        public List<EX2_10_1> _Read(OracleDataReader rdr)
        {                                                                                                  
            List<EX2_10_1> listEX2_10_1 = new List<EX2_10_1>();
            if (rdr.HasRows)                                                                               
            {                                                                                              
                while (rdr.Read())                                                                         
                {                                                                                          
                    ...
                    EX2_10_1 data = new EX2_10_1(splitresult);
                                                                                                           
                    listEX2_10_1.Add(data);
