...
{                                                                                                          
    class EX3_6dataService : DataService<EX3_6>                                             
    {                                                                                                      
        ...
        {                                                                                                  
            ...
            //string sql = GetSelectSQL(new EX3_6(), whereCondition);
        ...
        public List<EX3_6> _Read(OracleDataReader rdr)
        {                                                                                                  
            List<EX3_6> listEX3_6 = new List<EX3_6>();
            if (rdr.HasRows)                                                                               
            {                                                                                              
                while (rdr.Read())                                                                         
                {                                                                                          
                    ...
                    EX3_6 data = new EX3_6(splitresult);
